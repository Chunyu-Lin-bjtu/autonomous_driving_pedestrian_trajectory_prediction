...
def set_train_args():
    ...
    # width and height of context patch for each input point
    parser.add_argument('--patch_size', type=int, default=1280 / 2,
                        help='width and height of context patch for each input point')
    ...
    parser.add_argument('--target_size_cnn', type=int, default=128,
